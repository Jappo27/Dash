...
var Splitter = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var createPanel = function createPanel2(panel, index) {
    ...
    var gutter = index !== props.children.length - 1 && React.createElement("div", gutterProps, React.createElement("div", gutterHandlerProps));
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", rootProps2, getPanelProp(panel, "children")), gutter);
  };
