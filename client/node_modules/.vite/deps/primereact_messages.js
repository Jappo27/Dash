...
var UIMessage = React4.memo(React4.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (closable !== false) {
      ...
      return React4.createElement("button", buttonProps, _closeIcon2, React4.createElement(Ripple, null));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (props.message) {
      ...
      return content || React4.createElement(React4.Fragment, null, iconContent, React4.createElement("span", summaryProps, summary), React4.createElement("span", detailProps, detail));
    }
    return null;
  };
  ...
  return React4.createElement("div", rootProps, React4.createElement("div", wrapperProps, message, closeIcon));
}));
...
var messageIdx = 0;
var Messages = React4.memo(React4.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  return React4.createElement("div", _extends4({
    ref: elementRef
  }, rootProps), React4.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(message, index) {
    var messageRef = React4.createRef();
    return React4.createElement(CSSTransition, _extends4({
      nodeRef: messageRef,
      key: message._pId
    }, transitionProps), React4.createElement(UIMessage, {
      hostName: "Messages",
      ref: messageRef,
      message,
