...
var PanelMenuSub = React.memo(React.forwardRef(function(props, ref) {
  ...
  var createMenuItem = function createMenuItem2(processedItem, index) {
    ...
    var submenuIcon = item.items && IconUtils.getJSXIcon(active ? props.collapseIcon || React.createElement(ChevronDownIcon, submenuIconProps) : props.expandIcon || React.createElement(ChevronRightIcon, submenuIconProps));
    ...
    return React.createElement("li", _extends({}, menuitemProps, {
      key
    }), React.createElement("div", contentProps, content), submenu);
  };
...
var PanelMenuList = React.memo(function(props) {
  ...
  var _flatItems = function flatItems(processedItems2) {
...
var PanelMenu = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _findNextHeader = function findNextHeader(panelElement) {
    ...
    return headerElement ? DomHandler.getAttribute(headerElement, "data-p-disabled") ? _findNextHeader(headerElement.parentElement) : headerElement : null;
  };
  var _findPrevHeader = function findPrevHeader(panelElement) {
    ...
    return headerElement ? DomHandler.getAttribute(headerElement, "data-p-disabled") ? _findPrevHeader(headerElement.parentElement) : headerElement : null;
  };
  ...
  var updateFocusedHeader = function updateFocusedHeader2(event) {
    ...
    var header2 = selfCheck ? DomHandler.findSingle(panelElement, '[data-pc-section="header"]') : focusOnNext ? _findNextHeader(panelElement) : _findPrevHeader(panelElement);
  ...
  var createPanel = function createPanel2(item, index) {
    ...
    var submenuIcon = item.items && IconUtils.getJSXIcon(active ? props.collapseIcon || React.createElement(ChevronDownIcon, headerSubmenuIconProps) : props.expandIcon || React.createElement(ChevronRightIcon, headerSubmenuIconProps));
    ...
    return React.createElement("div", _extends({}, panelProps, {
      key
    }), React.createElement("div", headerProps, React.createElement("div", headerContentProps, content)), React.createElement(CSSTransition, _extends({
